...
describe 'nfs' do
  ...
  supported_os = ['Ubuntu_16.04', 'Ubuntu_18.04', 'Ubuntu_20.04', 'Ubuntu_22.04', 'Debian_8', 'Debian_9', 'Debian_10', 'Debian_11', 'RedHat_default', 'RedHat_7', 'RedHat_75', 'RedHat_8', 'Gentoo',
                  'SLES']
  supported_os.each do |os|
    context os do
      ...
      when 'Ubuntu_default'
        ...
        client_nfs_vfour_services = ['rpcbind']
      ...
      when 'Debian_default'
        ...
        server_packages = ['nfs-common', 'nfs-kernel-server', 'nfs4-acl-tools', 'rpcbind']
        client_services = ['rpcbind']
        client_nfs_vfour_services = ['rpcbind', 'nfs-common']
        client_packages = ['nfs-common', 'nfs4-acl-tools']
        client_gssdopt_name = 'RPCGSSDOPTS'
        defaults_file = '/etc/default/nfs-common'
        idmapd_file = '/etc/idmapd.conf'
      ...
      when 'RedHat_default'
        ...
        client_services = ['rpcbind']
        client_nfs_vfour_services = ['rpcbind', 'rpcidmapd']
      ...
      when 'RedHat_7'
        ...
        client_nfs_vfour_services = ['rpcbind.service', 'rpcbind.socket']
        client_packages = ['nfs-utils', 'nfs4-acl-tools', 'rpcbind']
        client_gssdopt_name = 'RPCGSSDARGS'
        defaults_file = '/etc/sysconfig/nfs'
        idmapd_file = '/etc/idmapd.conf'
      ...
      when 'RedHat_8'
        ...
        server_service = 'nfs-server.service'
        server_servicehelpers = ['nfs-idmapd.service']
        server_packages = ['nfs-utils', 'nfs4-acl-tools', 'rpcbind']
        client_services = ['rpcbind.service']
        client_nfs_vfour_services = ['rpcbind']
        client_packages = ['nfs-utils', 'nfs4-acl-tools', 'rpcbind']
      ...
      when 'Gentoo'
        ...
        server_service = 'nfs'
        server_servicehelpers = ['rpc.idmapd']
        server_packages = ['net-nds/rpcbind', 'net-fs/nfs-utils', 'net-libs/libnfsidmap']
        client_services = ['rpcbind']
        client_nfs_vfour_services = ['rpcbind', 'rpc.idmapd']
      ...
      when 'SLES'
        ...
        client_services = ['rpcbind', 'nfs']
        client_nfs_vfour_services = ['rpcbind', 'nfs']
      ...
      context 'when :nfs_v4_client => true, :nfs_v4 => true, :server_enabled => true, :manage_server_service => false, manage_server_servicehelper => false, :manage_client_service => false' do
        let(:params) do
          { nfs_v4_client: true, nfs_v4: true, client_enabled: true, server_enabled: true, manage_server_service: false, manage_server_servicehelper: false, manage_client_service: false }
        end
      ...
      context "when :nfs_v4_client => true, :client_enabled => true, nfs_v4 => true, client_rpcbind_config => #{client_rpcbind_config}" do
        let(:params) do
          { nfs_v4: true, nfs_v4_client: true, client_enabled: true, client_rpcbind_config: client_rpcbind_config, client_rpcbind_optname: client_rpcbind_optname,
client_rpcbind_opts: 'rpcbind_option' }
        end
